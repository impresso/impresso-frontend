...
<i18n lang="json">
{
  "en": {
    ...
    "tabs_permissionExplore_overview": "permission to explore in Web App",
    "tabs_permissionGetTranscript_overview": "permission to get transcript",
    "tabs_permissionGetImage_overview": "permission to get facsimile",
