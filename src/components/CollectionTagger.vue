<template>
  <div v-if="isLoggedIn()" class="collection-tagger">
    ...
    <div class="overlay" v-show="show">
      <div class="panel">
        <div class="header">
          <router-link class="btn btn-sm btn-primary" v-bind:to="{ name: 'collection' }"
            >Manage collections</router-link
          >
          <a v-on:click.prevent="toggle" href="#" class="btn btn-sm btn-dark"
            ><icon name="times"
          /></a>
        </div>
        <div class="body">
