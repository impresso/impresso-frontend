      ...
      <div class="content pl-4">
        ...
        <div class="d-flex flex-column">
          ...
          <div class="article-meta">
            <router-link
              :to="{ name: 'newspaper', params: { newspaper_id: newspaper.id } }"
              class="article-newspaper"
            >
              {{ newspaper.name }}
            </router-link>
            <item-selector :id="newspaper.id" :item="newspaper" type="newspaper" /> &nbsp;
...
export default {
  ...
  computed: {
    ...
    pageViewerOverlays() {
      return this.passage.pageRegions.map(([x, y, w, h]) => {
